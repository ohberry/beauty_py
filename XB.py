...
if __name__ == '__main__':
    # url_path = "aweme_id=7196239141472980280&aid=1128&version_name=23.5.0&device_platform=android&os_version=2333"
    url_path = (
        "aid=6383&sec_user_id=MS4wLjABAAAA5fOskZLfiDB9wvPP0LHJB_tDvwTnzKL2K3Cj1C-81YczaAhHUvFr-7BnpZ-yOiX6&count=20&max_cursor=0&cookie_enabled=true&platform=PC&downlink=10")
    XB = XBogus()
    xbogus = XB.getXBogus(url_path)
    print("XB_ogus:", xbogus)
